...
const Dashboard = () => {
  ...
  const populateFormFromLoyaltyData = useCallback((data) => {
    ...
    setLoyaltyFormData({
      ...
      icon1: data?.icon1Imag ? getImageUrl(data?.icon1Image) : null,
      icon2: data.icon2Image ? getImageUrl(data?.icon2Image) : null,
      icon3: data.icon3Image ? getImageUrl(data?.icon3Image) : null,

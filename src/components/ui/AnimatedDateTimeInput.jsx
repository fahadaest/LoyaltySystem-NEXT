...
const AnimatedDateTimeInput = ({
    ...
    return (
        <div className={`space-y-2 ${className}`}>
            ...
            <div className="relative group">
                <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 
                        ...
                        [&::-webkit-datetime-edit-hour-field]:text-gray-900
                        [&::-webkit-datetime-edit-hour-field]:dark:text-white
                        [&::-webkit-datetime-edit-minute-field]:text-gray-900
                        [&::-webkit-datetime-edit-minute-field]:dark:text-white
                        [&::-webkit-datetime-edit-ampm-field]:text-gray-900
                        [&::-webkit-datetime-edit-ampm-field]:dark:text-white
                        
                        ${!hasValue ? '[&::-webkit-datetime-edit-text]:text-gray-400 [&::-webkit-datetime-edit-month-field]:text-gray-400 [&::-webkit-datetime-edit-day-field]:text-gray-400 [&::-webkit-datetime-edit-year-field]:text-gray-400 [&::-webkit-datetime-edit-hour-field]:text-gray-400 [&::-webkit-datetime-edit-minute-field]:text-gray-400 [&::-webkit-datetime-edit-ampm-field]:text-gray-400' : ''}
                    `}
                    {...props}
                />
            ...
            {/* Display formatted date-time when value exists */}
            {hasValue && (
                <div className="text-xs text-brandGreen dark:text-brandGreen animate-fadeIn flex items-center gap-1">
...
export default AnimatedDateTimeInput;
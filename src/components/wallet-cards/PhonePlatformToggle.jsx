...
const PhonePlatformToggle = ({
    ...
    return (
        <div className={`flex ${isVertical ? 'flex-col' : 'flex-row'} items-center gap-2 bg-white rounded-full ${currentSize.container} shadow-lg ${className}`}>
            <button
                onClick={() => setPhoneType('iphone')}
                className={`${currentSize.button} rounded-full transition-all duration-200 ${phoneType === 'iphone'
            ...
            <button
                ...
                className={`${currentSize.button} rounded-full transition-all duration-200 ${phoneType === 'android'
                    ? 'bg-brandGreen text-white shadow-md'
                    : 'text-gray-600 hover:bg-gray-100'
                    }`}
...
export default PhonePlatformToggle;